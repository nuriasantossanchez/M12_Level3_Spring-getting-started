package springBootInitialDemo_Level_III.controller;
...
import springBootInitialDemo_Level_III.service.IGreetingService;
 ...
 * http://localhost:8082, en este caso
 * (el puerto 8082 queda especificado en el archivo application.properties, del directorio resources)
 *
 */
@RestController
public class GreetingController{
    ...
    /**
     * Representa el mapeo de una peticion HTTP GET, a la URL http://localhost:8082
     *
